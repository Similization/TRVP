export default class SpecialistApi {
    static async getSpecialist({specialistId} = {specialistId: null}) {
        try {
    ...
    static async createSpecialist({name, startTime, endTime, skills} = {name, startTime, endTime, skills}) {
        try {
            const specialistResponse = await fetch(
                `http://localhost:8080/specialist/`, 
                {
    ...
    static async updateSpecialist({specialistId, name, startTime, endTime, skills} = {specialistId: null, name, startTime, endTime, skills}) {
        try {
            const specialistResponse = await fetch(
                `http://localhost:8080/specialist/${specialistId}`, 
                {
    ...
    static async deleteSpecialist({specialistId} = {specialistId: null}) {
        try {
            const specialistResponse = await fetch(
                `http://localhost:8080/specialist/${specialistId}`, 
                {
